...
const resources = {
  en: {
    translation: {
      ...
      nav: { home: 'Knowledge Base', add: 'Add Knowledge', tags: 'Tags', stats: 'Statistics', monitoring: 'Monitoring' },
      ...
      stats: { title: 'Knowledge Statistics', total: 'Total Entries', byType: 'By Type', byScope: 'By Scope', tagCloud: 'Tag Cloud', cleanCache: 'Clean cache', cacheClean: 'Cache clean' },
      ...
      monitoring: {
        title: 'Monitoring', subtitle: 'Service status and management',
        ...
        uninstallSuccess: 'Monitoring data removed successfully. This page will stop working shortly.',
      },
      update: { check: 'Check for updates', checking: 'Checking...', upToDate: 'Up to date', available: 'Update available' },
  ...
  es: {
    translation: {
      ...
      nav: { home: 'Base de Conocimiento', add: 'Agregar Conocimiento', tags: 'Etiquetas', stats: 'Estadísticas', monitoring: 'Monitoreo' },
      ...
      stats: { title: 'Estadísticas de Conocimiento', total: 'Entradas Totales', byType: 'Por Tipo', byScope: 'Por Ámbito', tagCloud: 'Nube de Etiquetas', cleanCache: 'Limpiar caché', cacheClean: 'Caché limpio' },
      ...
      monitoring: {
        title: 'Monitoreo', subtitle: 'Estado y gestión de servicios',
      ...
      update: { check: 'Buscar actualizaciones', checking: 'Buscando...', upToDate: 'Actualizado', available: 'Actualización disponible' },
  ...
  pt: {
    translation: {
      ...
      nav: { home: 'Base de Conhecimento', add: 'Adicionar Conhecimento', tags: 'Tags', stats: 'Estatísticas', monitoring: 'Monitoramento' },
      ...
      stats: { title: 'Estatísticas de Conhecimento', total: 'Total de Entradas', byType: 'Por Tipo', byScope: 'Por Escopo', tagCloud: 'Nuvem de Tags', cleanCache: 'Limpar cache', cacheClean: 'Cache limpo' },
      ...
      monitoring: {
        title: 'Monitoramento', subtitle: 'Status e gerenciamento dos serviços',
      ...
      update: { check: 'Verificar atualizações', checking: 'Verificando...', upToDate: 'Atualizado', available: 'Atualização disponível' },
