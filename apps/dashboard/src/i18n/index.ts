...
const resources = {
  en: {
    translation: {
      ...
      nav: { home: 'Knowledge Base', add: 'Add Knowledge', tags: 'Tags', plans: 'Plans', stats: 'Statistics', statsKnowledge: 'Knowledge', statsPlans: 'Plans', settings: 'Settings', widgets: 'Widgets', health: 'Health', quickStats: 'Quick Stats', workspace: 'Workspace', secondBrain: 'Second Brain', contextEngine: 'Context Engine' },
  ...
  es: {
    translation: {
      ...
      nav: { home: 'Base de Conocimiento', add: 'Agregar Conocimiento', tags: 'Etiquetas', plans: 'Planes', stats: 'Estadísticas', statsKnowledge: 'Conocimiento', statsPlans: 'Planes', settings: 'Configuración', widgets: 'Widgets', health: 'Salud', quickStats: 'Estadísticas Rápidas', workspace: 'Workspace', secondBrain: 'Segundo Cerebro', contextEngine: 'Motor de Contexto' },
  ...
  pt: {
    translation: {
      ...
      nav: { home: 'Base de Conhecimento', add: 'Adicionar Conhecimento', tags: 'Tags', plans: 'Planos', stats: 'Estatísticas', statsKnowledge: 'Conhecimento', statsPlans: 'Planos', settings: 'Configurações', widgets: 'Widgets', health: 'Saúde', quickStats: 'Estatísticas Rápidas', workspace: 'Workspace', secondBrain: 'Segundo Cérebro', contextEngine: 'Motor de Contexto' },
