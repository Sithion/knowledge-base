...
const resources = {
  en: {
    translation: {
      ...
      update: { section: 'Updates', check: 'Check for updates', checking: 'Checking...', upToDate: 'Up to date', available: 'Update available', checkFailed: 'Check failed — try again', viewRelease: 'View release', restartToApply: 'Update installed — restart to apply' },
      settings: {
  ...
  es: {
    translation: {
      ...
      update: { section: 'Actualizaciones', check: 'Buscar actualizaciones', checking: 'Buscando...', upToDate: 'Actualizado', available: 'Actualización disponible', checkFailed: 'Error al verificar — intenta de nuevo', viewRelease: 'Ver lanzamiento', restartToApply: 'Actualización instalada — reinicia para aplicar' },
      settings: {
  ...
  pt: {
    translation: {
      ...
      update: { section: 'Atualizações', check: 'Verificar atualizações', checking: 'Verificando...', upToDate: 'Atualizado', available: 'Atualização disponível', checkFailed: 'Erro ao verificar — tente novamente', viewRelease: 'Ver lançamento', restartToApply: 'Atualização instalada — reinicie para aplicar' },
      settings: {
